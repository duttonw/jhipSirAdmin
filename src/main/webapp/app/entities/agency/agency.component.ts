...
export class AgencyComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    this.agencyService
      ...
      .subscribe(
        (res: HttpResponse<IAgency[]>) => this.paginateAgencies(res.body, res.headers),
  ...
  trackId(index: number, item: IAgency) {
    return item.id;
  }
  ...
  protected paginateAgencies(data: IAgency[], headers: HttpHeaders) {
