...
/**
 * Criteria class for the {@link au.gov.qld.sir.domain.ServiceSupportRoleContextType} entity. This class is used
 * in {@link au.gov.qld.sir.web.rest.ServiceSupportRoleContextTypeResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /service-support-role-context-types?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class ServiceSupportRoleContextTypeCriteria implements Serializable, Criteria {
    ...
    public ServiceSupportRoleContextTypeCriteria(){
    }

    public ServiceSupportRoleContextTypeCriteria(ServiceSupportRoleContextTypeCriteria other){
    ...
    @Override
    public ServiceSupportRoleContextTypeCriteria copy() {
        return new ServiceSupportRoleContextTypeCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ServiceSupportRoleContextTypeCriteria that = (ServiceSupportRoleContextTypeCriteria) o;
        return
    ...
    public String toString() {
        return "ServiceSupportRoleContextTypeCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
