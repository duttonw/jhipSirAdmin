...
/**
 * Criteria class for the {@link au.gov.qld.sir.domain.LocationEmail} entity. This class is used
 * in {@link au.gov.qld.sir.web.rest.LocationEmailResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /location-emails?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class LocationEmailCriteria implements Serializable, Criteria {
    ...
    public LocationEmailCriteria(){
    }

    public LocationEmailCriteria(LocationEmailCriteria other){
    ...
    @Override
    public LocationEmailCriteria copy() {
        return new LocationEmailCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final LocationEmailCriteria that = (LocationEmailCriteria) o;
        return
