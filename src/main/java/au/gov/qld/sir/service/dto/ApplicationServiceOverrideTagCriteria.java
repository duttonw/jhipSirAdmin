...
/**
 * Criteria class for the {@link au.gov.qld.sir.domain.ApplicationServiceOverrideTag} entity. This class is used
 * in {@link au.gov.qld.sir.web.rest.ApplicationServiceOverrideTagResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /application-service-override-tags?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class ApplicationServiceOverrideTagCriteria implements Serializable, Criteria {
    ...
    public ApplicationServiceOverrideTagCriteria(ApplicationServiceOverrideTagCriteria other){
    ...
    @Override
    public ApplicationServiceOverrideTagCriteria copy() {
        return new ApplicationServiceOverrideTagCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ApplicationServiceOverrideTagCriteria that = (ApplicationServiceOverrideTagCriteria) o;
        return
    ...
    public String toString() {
        return "ApplicationServiceOverrideTagCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
                (name != null ? "name=" + name + ", " : "") +
