...
/**
 * Criteria class for the {@link au.gov.qld.sir.domain.AgencySupportRoleContextType} entity. This class is used
 * in {@link au.gov.qld.sir.web.rest.AgencySupportRoleContextTypeResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /agency-support-role-context-types?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class AgencySupportRoleContextTypeCriteria implements Serializable, Criteria {
    ...
    public AgencySupportRoleContextTypeCriteria(){
    }

    public AgencySupportRoleContextTypeCriteria(AgencySupportRoleContextTypeCriteria other){
    ...
    @Override
    public AgencySupportRoleContextTypeCriteria copy() {
        return new AgencySupportRoleContextTypeCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final AgencySupportRoleContextTypeCriteria that = (AgencySupportRoleContextTypeCriteria) o;
        return
    ...
    public String toString() {
        return "AgencySupportRoleContextTypeCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
