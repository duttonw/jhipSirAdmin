...
import au.gov.qld.sir.config.Constants;
import au.gov.qld.sir.domain.Authority;
import au.gov.qld.sir.domain.User;
import au.gov.qld.sir.repository.AuthorityRepository;
import au.gov.qld.sir.repository.UserRepository;
import au.gov.qld.sir.security.AuthoritiesConstants;
import au.gov.qld.sir.service.MailService;
import au.gov.qld.sir.service.UserService;
import au.gov.qld.sir.service.dto.PasswordChangeDTO;
import au.gov.qld.sir.service.dto.UserDTO;
import au.gov.qld.sir.web.rest.errors.ExceptionTranslator;
import au.gov.qld.sir.web.rest.vm.KeyAndPasswordVM;
import au.gov.qld.sir.web.rest.vm.ManagedUserVM;
