...
import au.gov.qld.sir.config.audit.AuditEventConverter;
import au.gov.qld.sir.domain.PersistentAuditEvent;
...
import static au.gov.qld.sir.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
