...
import { ServiceDeliveryComponent } from 'app/entities/service-delivery/service-delivery.component';
...
describe('Component Tests', () => {
  describe('ServiceDelivery Management Component', () => {
    let comp: ServiceDeliveryComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [ServiceDeliveryComponent],
        providers: [
          {
        ...
        .overrideTemplate(ServiceDeliveryComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.serviceDeliveries[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
