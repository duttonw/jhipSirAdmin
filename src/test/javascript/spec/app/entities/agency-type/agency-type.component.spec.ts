...
import { AgencyTypeComponent } from 'app/entities/agency-type/agency-type.component';
...
describe('Component Tests', () => {
  describe('AgencyType Management Component', () => {
    let comp: AgencyTypeComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(AgencyTypeComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.agencyTypes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
