...
import { IntegrationMappingComponent } from 'app/entities/integration-mapping/integration-mapping.component';
...
describe('Component Tests', () => {
  describe('IntegrationMapping Management Component', () => {
    let comp: IntegrationMappingComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(IntegrationMappingComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new IntegrationMapping(123)],
            headers
          })
        )
      );
      ...
      expect(comp.integrationMappings[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
