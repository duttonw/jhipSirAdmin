...
import { ServiceTagComponent } from 'app/entities/service-tag/service-tag.component';
...
describe('Component Tests', () => {
  describe('ServiceTag Management Component', () => {
    let comp: ServiceTagComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ServiceTagComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.serviceTags[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
