...
import { ServiceEventComponent } from 'app/entities/service-event/service-event.component';
...
describe('Component Tests', () => {
  describe('ServiceEvent Management Component', () => {
    let comp: ServiceEventComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ServiceEventComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.serviceEvents[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
