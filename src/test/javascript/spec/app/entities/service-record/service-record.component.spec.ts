...
import { ServiceRecordComponent } from 'app/entities/service-record/service-record.component';
...
describe('Component Tests', () => {
  describe('ServiceRecord Management Component', () => {
    let comp: ServiceRecordComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ServiceRecordComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.serviceRecords[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
