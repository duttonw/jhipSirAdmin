...
import { ServiceGroupComponent } from 'app/entities/service-group/service-group.component';
...
describe('Component Tests', () => {
  describe('ServiceGroup Management Component', () => {
    let comp: ServiceGroupComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ServiceGroupComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.serviceGroups[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
