...
import { ServiceNameComponent } from 'app/entities/service-name/service-name.component';
...
describe('Component Tests', () => {
  describe('ServiceName Management Component', () => {
    let comp: ServiceNameComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ServiceNameComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.serviceNames[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
