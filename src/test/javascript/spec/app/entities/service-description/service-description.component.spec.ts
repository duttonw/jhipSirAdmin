...
import { ServiceDescriptionComponent } from 'app/entities/service-description/service-description.component';
...
describe('Component Tests', () => {
  describe('ServiceDescription Management Component', () => {
    let comp: ServiceDescriptionComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ServiceDescriptionComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new ServiceDescription(123)],
            headers
          })
        )
      );
      ...
      expect(comp.serviceDescriptions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
