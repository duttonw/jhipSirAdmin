...
describe('Service Tests', () => {
  describe('ServiceDescription Service', () => {
    let injector: TestBed;
    let service: ServiceDescriptionService;
    let httpMock: HttpTestingController;
    let elemDefault: IServiceDescription;
    let expectedResult;
    ...
    beforeEach(() => {
      ...
      expectedResult = {};
      injector = getTestBed();
      service = injector.get(ServiceDescriptionService);
      httpMock = injector.get(HttpTestingController);
      currentDate = moment();

      elemDefault = new ServiceDescription(
        0,
        'AAAAAAA',
        currentDate,
        'AAAAAAA',
    ...
    describe('Service methods', () => {
      ...
      it('should create a ServiceDescription', async () => {
        const returnedFromService = Object.assign(
          {
            id: 0,
            createdDateTime: currentDate.format(DATE_TIME_FORMAT),
        ...
        service
          .create(new ServiceDescription(null))
          .pipe(take(1))
          .subscribe(resp => (expectedResult = resp));
      ...
      it('should update a ServiceDescription', async () => {
        const returnedFromService = Object.assign(
          {
            createdBy: 'BBBBBB',
            createdDateTime: currentDate.format(DATE_TIME_FORMAT),
      ...
      it('should return a list of ServiceDescription', async () => {
        const returnedFromService = Object.assign(
          {
            createdBy: 'BBBBBB',
            createdDateTime: currentDate.format(DATE_TIME_FORMAT),
      ...
      it('should delete a ServiceDescription', async () => {
