...
describe('Service Tests', () => {
  describe('Agency Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Agency(0, 'AAAAAAA', currentDate, 'AAAAAAA', currentDate, 0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should return a list of Agency', async () => {
        const returnedFromService = Object.assign(
          {
            createdBy: 'BBBBBB',
            createdDateTime: currentDate.format(DATE_TIME_FORMAT),
