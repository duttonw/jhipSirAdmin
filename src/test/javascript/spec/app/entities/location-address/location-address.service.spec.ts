...
describe('Service Tests', () => {
  describe('LocationAddress Service', () => {
    let injector: TestBed;
    let service: LocationAddressService;
    let httpMock: HttpTestingController;
    let elemDefault: ILocationAddress;
    let expectedResult;
    ...
    beforeEach(() => {
      ...
      expectedResult = {};
      injector = getTestBed();
      service = injector.get(LocationAddressService);
      httpMock = injector.get(HttpTestingController);
      currentDate = moment();

      elemDefault = new LocationAddress(
        0,
        'AAAAAAA',
        currentDate,
        'AAAAAAA',
    ...
    describe('Service methods', () => {
      ...
      it('should create a LocationAddress', async () => {
        const returnedFromService = Object.assign(
          {
            id: 0,
            createdDateTime: currentDate.format(DATE_TIME_FORMAT),
        ...
        service
          .create(new LocationAddress(null))
          .pipe(take(1))
          .subscribe(resp => (expectedResult = resp));
      ...
      it('should update a LocationAddress', async () => {
        const returnedFromService = Object.assign(
          {
            createdBy: 'BBBBBB',
            createdDateTime: currentDate.format(DATE_TIME_FORMAT),
      ...
      it('should return a list of LocationAddress', async () => {
        const returnedFromService = Object.assign(
          {
            createdBy: 'BBBBBB',
            createdDateTime: currentDate.format(DATE_TIME_FORMAT),
      ...
      it('should delete a LocationAddress', async () => {
