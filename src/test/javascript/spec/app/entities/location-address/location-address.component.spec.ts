...
import { LocationAddressComponent } from 'app/entities/location-address/location-address.component';
...
describe('Component Tests', () => {
  describe('LocationAddress Management Component', () => {
    let comp: LocationAddressComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(LocationAddressComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.locationAddresses[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
